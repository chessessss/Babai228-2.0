...
img_hero = "pngegg.png"  # герой
img_bullet = "bullet.png" # куля
img_enemy = "ufo.png"  # ворог
img_ast = "meteor.png" # астероїд
...
win_width = 700
win_height = 500
display.set_caption("Space Indvaders 2.0")
window = display.set_mode((win_width, win_height))
background = transform.scale(image.load(img_back), (win_width, win_height))
 
# створюємо спрайти
ship = Player(img_hero, 5, win_height - 100, 70, 100, 10)
...
for i in range(1, 3):
    asteroid = Enemy(img_ast, randint(30, win_width - 30), -40, 80, 80, randint(1, 7))
    ...
    if not finish:
        ...
        if rel_time == True:
            ...
            if now_time - last_time < 3: #поки не минуло 3 секунди виводимо інформацію про перезарядку
                reload = font2.render('Зачекай, перезарядка!', 1, (200, 0, 0))
        ...
        for c in collides:
            ...
            score = score + 1
            monster = Enemy(img_enemy, randint(80, win_width - 80), -40, 80, 70, randint(1, 5))
            monsters.add(monster)
